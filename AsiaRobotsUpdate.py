...
try:
    ...
    hubCount = 1
    #robotCount = 1
    for hub in range(hubCount,2):

        for robotName in robotList:
            robotCount = 1
            for robot in range(1, 101):
                callback = r"""C:\Progra~1\Nimsoft\bin\pu -u administrator -p interOP@123 /CHOSERVER1_domain/CHOSERVER1_hub/CHOSERVER1/automated_deployment_engine deploy_probe robot_update 9.30 /CHOSERVER1_domain/chosechub{}/{}{}""".format(hubCount,robotName,robotCount)
                print(callback)
